...
class AudiosFragment_ : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            try {
                ...
                holder.itemView.setOnLongClickListener {v ->
                    Log.i("Darwincio_del", "On long click position = "+holder.adapterPosition)
                    Log.i("Darwincio_del", "mAudios.length = "+mAudios.size)
